...
while True:
    ...
    tabuleiro_inicial = '''
--- COMO JOGAR ---
When it's your turn, type the number corresponding to the position on the board to make your move there.
For example, let's say you want to play in the center, so you type 5.
